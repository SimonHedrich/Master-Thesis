...
% Zotero-managed library (research/literature/references.bib), copied here so the
% manuscript is self-contained. Chapter 2 cites these Better-BibTeX keys directly;
% bibliography/references.bib holds only the project-specific entries that have no
% Zotero record. Refresh with: cp research/literature/references.bib
% thesis/manuscript/bibliography/references_zotero.bib
...
% use roman numbering for preamble
    ...
    \input{preamble/eidesstattliche_erklaerung}
    ...
    \include{chapters/3-Methods_and_Implementation/30-Overview}
    \include{chapters/4-Results}
    \include{chapters/5-Discussion_and_Conclusion}
