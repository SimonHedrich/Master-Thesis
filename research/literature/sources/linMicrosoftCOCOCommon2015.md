...
Tsung-Yi Lin James Hays Michael Maire Pietro Perona Serge Belongie Deva Ramanan Lubomir Bourdev C. Lawrence Zitnick Ross Girshick Piotr Doll´ ar
...
· L. Bourdev and P. Doll´ ar are with Facebook AI Research. The majority of this work was performed while P. Doll´ ar was with Microsoft Research.
...
An important property of our dataset is we strive to find non-iconic images containing objects in their natural context. The amount of contextual information present in an image can be estimated by examining the average number of object categories and instances per image, Fig. 5(b, c). For ImageNet we plot the object detection validation set, since the training data only has a single object labeled. On average our dataset contains 3.5 categories and 7.7 instances per image. In comparison ImageNet and PASCAL VOC both have less than 2 categories and 3 instances per image on average. Another interesting observation is only 10% of the images in MS COCOhave only one category per image, in comparison, over 60% of images contain a single object category in ImageNet and PASCAL VOC. As expected, the SUN dataset has the most contextual information since it is scene-based and uses an unrestricted set of categories.
...
airpane frisbee laptop mouse toaster tennisr
...
|         |   plane bike bird boat |   plane bike bird boat | plane bike bird boat   |   plane bike bird boat |   bottle bus car | bottle bus car   |   cat |   chair |   cow |   table |   dog |   horse |   moto |   person |   plant | sheep     |   sofa | train tv avg.   |
|---------|------------------------|------------------------|------------------------|------------------------|------------------|------------------|-------|---------|-------|---------|-------|---------|--------|----------|---------|-----------|--------|-----------------|
...
To download and learn more about MS COCO please see the project website 2 . MS COCO will evolve and grow over time; up to date information is available online.
...
- [19] T. Lin, M. Maire, S. Belongie, J. Hays, P. Perona, D. Ramanan, P. Doll´ ar, and C. L. Zitnick, 'Microsoft COCO: Common objects in context,' in ECCV , 2014.
...
- [32] E. Hjelm˚ as and B. Low, 'Face detection: A survey,' CVIU , vol. 83, no. 3, pp. 236-274, 2001.
...
(a) PASCAL VOC. (b) MS COCO. Fig. 13: Random person instances from PASCAL VOC and MS COCO. At most one instance is sampled per image.

<!-- image -->

TABLE 2: Candidate category list (272). Bold : selected categories (91). Bold ∗ : omitted categories in 2014 release (11).

| person              | bicycle           | car          | motorcycle           | bird               | cat                           | dog                | horse license   | sheep bed     | bottle             |
|---------------------|-------------------|--------------|----------------------|--------------------|-------------------------------|--------------------|-----------------|---------------|--------------------|
| chair               | couch             | potted plant | tv                   | cow                | airplane                      | hat ∗              | plate           |               | laptop             |
...
| skateboard          | helicopter        | tomato       | tree                 | bunny ∗            | pillow                        | tennis racket      | cake            | feet          | bench cheese       |
| chopping board goat | washer magazine   | lion key     | monkey picture frame | hair brush cupcake | light switch fan (ceil/floor) | arms frogs         | legs rabbit     | house owl     | scarf              |
|                     |                   |              | strawberries         |                    | van                           | kangaroo           | rhinoceros      | sailboat      |                    |
| ears                | home phone        | pig          |                      | pumpkin            |                               |                    |                 |               | deer               |
| playing cards       | towel             | hyppo tablet | can corn             | dollar bill ladder | doll pineapple                | soup candle        | meat desktop    | window carpet | muffins cookie     |
| tire toy cars       | necklace bracelet | bat          | balloon              | gloves             | milk                          | pants              | wheelchair      | building      | bacon              |
...
| moon                | road/street       | fountain     | fax machine          | bat                | air balloon                   | cereal             | seahorse        | rocket        | cabinets           |
| basketball          | telephone         | movie (disc) | football             | goose              | hot long sleeve shirt         | short sleeve shirt | raft            | rooster       | copier             |
|                     | fences            | goal net     | toys                 | engine             | soccer ball                   | field goal posts   | socks           | tennis net    | seats              |
| radio elbows        | aardvark          | dinosaur     | unicycle             | honey              | legos                         | fly                | roof            | baseball      | mat                |
...
library child's room street lighthouse church dining room park railway office auditorium beach playground restaurant shop river swimming pool kitchen home village forest living room hotel valley gas station bathroom classroom market garden factory cafeteria harbor farm campus hospital room yard mountain bedroom food court parking lot plaza TABLE 3: Scene category list.