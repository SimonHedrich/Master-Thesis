...
# training/val crops are synthetic-only, generated separately and never part
# of `data/real/annotations_*.json`. Merged into train/val at dataset
# construction time (never into test). See `TODO.md` §4.7.
