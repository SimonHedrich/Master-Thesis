...
**Checkpoint:** `/home/debian/Master-Thesis/scripts/synthetic_model_comparison/training/model_exports/yolo26n-sd35-large-turbo-maxlen-seed42-20260804-031104/best.pt`  
**max_det:** 100
...
Overall within-group fine-confusion rate: 0.181

| Look-alike group | matched | confused | rate |
|------------------|---------|----------|------|
| zebra | 1147 | 375 | 0.327 |
| ursus | 923 | 0 | 0.000 |
| bison | 0 | 0 | — |
| bos | 0 | 0 | — |
| canis | 0 | 0 | — |
