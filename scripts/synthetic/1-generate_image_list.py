...
ANGLE_DESCRIPTIONS = {
    ...
    "side_profile": "Pure lateral view, camera perpendicular to the animal's long axis",
    "three_quarter_front": (
...
BAND_B_SCHEDULE: list[ShotGroup] = [
    ShotGroup("eye_level",           "medium",     15, "train"),
    ShotGroup("low",                 "medium",     12, "train"),
    ShotGroup("high",                "medium",     12, "train"),
    ShotGroup("head_on",             "medium",     12, "train"),
    ShotGroup("rear",                "medium",     12, "train"),
    ShotGroup("side_profile",        "medium-far", 10, "train"),
    ShotGroup("three_quarter_front", "medium",      8, "train"),
    ShotGroup("eye_level",           "far",         8, "train"),
    ShotGroup("varies",              "medium",      5, "train", occlusion="partial_vegetation"),
    ShotGroup("species_specific",    "varies",      6, "train"),
]
    ...
    for cls in classes:
        ...
        for group in schedule:
            for slot_idx in range(group.count):
                ...
                image_filename = f"{band_lower}_{slug}_{image_num:03d}.jpg"
